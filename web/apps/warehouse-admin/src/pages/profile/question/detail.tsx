...
const LayoutQuestionDetailQuestion: React.FC<{
    ...
    return (
        <Modals isOpen={isOpenEdit} setOpen={onClose} title="Detail Pertanyaan" size="3xl">
            <HStack mb={2}>
                <Avatar size={'xl'} src={data.creator.imageUrl} name={data.creator.name} />
            ...
            <Box experimental_spaceY={3} pb={4}>
                <FormControlsTextArea readOnly label="question" title={'Pertanyaan'} register={register} placeholder={''} />

                <FormControlsTextArea readOnly label="answer" title={'Jawaban'} register={register} placeholder={'...'} />
            </Box>
        </Modals>
    )
}
