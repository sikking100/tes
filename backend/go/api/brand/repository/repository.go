...
func NewRepository() (*mongo.Client, *Repository, error) {
	...
	db := client.Database("brand").Collection("brand")
...
func (repo *Repository) Find(ctx context.Context) ([]*entity.Brand, error) {
	cur, err := repo.db.Find(ctx, bson.M{}, options.Find().SetSort(bson.M{"name": 1}))
	if err != nil {
		return nil, toError(err)
	}
	items := make([]*entity.Brand, 0)
...
func (repo *Repository) Save(ctx context.Context, id string, name string) (*entity.Brand, error) {
...
func (repo *Repository) UpdateImage(ctx context.Context, id, url string) error {
...
func (repo *Repository) FindById(ctx context.Context, id string) (*entity.Brand, error) {
	var result entity.Brand
...
func (repo *Repository) Delete(ctx context.Context, id string) (*entity.Brand, error) {
	var result entity.Brand
